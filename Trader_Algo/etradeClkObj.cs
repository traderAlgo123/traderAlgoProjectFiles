...
{
    public class etradeClkObj
    {
        public int etradeMstClkHour = new int();
        public int etradeMstClkMinute = new int();
        public int etradeMstClkSecond = new int();
        public string etradeMstClkAMPM;
    }
}
